                ...
                <div class="page-content">
					...
					<!-- BEGIN CONDENSED TABLE PORTLET-->
                                   ...
                                   <!--  <div class="portlet box blue">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-picture"></i>Release Environment (TST01-04)</div>
                                            <div class="tools">
                               ...
                               int k=0;
						 		for(int i=0;i<nodeCount;i++)
						 		{
						 		 String tst_type= n4.item(i).getFirstChild().getNodeValue();
						 			...
						 			/*  if(tst_type.equalsIgnoreCase("Release"))
						 			{ */
		                             ...
		                             <%--  <td>
		                                    <!-- BEGIN Portlet PORTLET-->
											 ...
											 <div> 
		                                         <div class="portlet-title"> 
		                                        <!-- <div> -->
		                                          <div class="caption"><%= n6.item(i).getFirstChild().getNodeValue() %></div> 
		                                             <div class="caption">
												...
												<%-- <table class="table table-bordered table-hover">
		                                                    ...
		                                                    <tbody>
		                                                        ...
		                                                        <tr>
		                                                            ...
		                                                            <td rowspan=2><button type="button" class="btn blue btn-sm" onclick="window.location='details.jsp?tsthostname=<%= n7.item(i).getFirstChild().getNodeValue() %>'">Detail</button></td>
		                                                        </tr>
